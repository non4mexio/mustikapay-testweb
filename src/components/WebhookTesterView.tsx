...
import { Send, Copy, Check, RefreshCw, Terminal, CheckCircle2, XCircle, ShieldCheck, AlertCircle, Code, ChevronDown, ChevronUp } from 'lucide-react';
...
export const WebhookTesterView: React.FC<WebhookTesterViewProps> = ({
  ...
  }, [refNo, amount, issuer, payor, status]);
    ...
    <div className="max-w-5xl mx-auto space-y-6">
      ...
      <div className="bg-white rounded-2xl p-6 border border-slate-200 shadow-xs space-y-3">
        <div className="flex items-start justify-between gap-4">
          ...
          <span className="shrink-0 text-xs font-medium px-2.5 py-1 rounded-full bg-emerald-50 text-emerald-800 border border-emerald-200 flex items-center gap-1.5">
